...
function Projects() {
    return (
        <ProjectsStyle className={"py-40 xl:px-80 lg:px-52 md:px-32 px-10 flex flex-col items-center"}>
            <LineElement/>
            <div className="heading mt-8 mb-5">
            ...
            <div className="projects flex flex-col w-full mt-40">
